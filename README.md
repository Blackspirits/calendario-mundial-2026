...
```txt
https://blackspirits.github.io/calendario-mundial-2026/mundial-2026.ics
```

Copia este URL — vais utilizá-lo nas instruções abaixo.

> Nota: recomenda-se utilizar o link do GitHub Pages em vez do `raw.githubusercontent.com`, porque alguns calendários podem interpretar melhor o ficheiro quando este é servido como calendário público. Os calendários também só voltam a sincronizar de tempos a tempos, normalmente entre algumas horas e um dia, por isso não esperes ver alterações em tempo real.
